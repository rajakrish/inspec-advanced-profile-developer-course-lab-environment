...
class Filtertable < Inspec.resource(1)
    ...
    filter_table.register_column(:favorite_color, field: :color)
    ...
    filter_table.register_custom_matcher(:has_red?)    { |filter_table| filter_table.favorite_color.uniq.eql?(['red']) }
    ...
    [
        { name: "Sarah", age: 12,  gender: "girl", toys: ['car','train','bike'], color:'red',school_name: 'Harvard' },
        { name: "John",  age: 9,   gender: "boy",  toys: ['top','bike'],school_name: 'Yale'},
